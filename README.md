...
<br />
<br />
This repository and code is based on the YOLO project by: Jocher, G., Chaurasia, A., & Qiu, J. (2023). Ultralytics YOLO (Version 8.0.0)
...
```
[Here](https://github.com/phiflip/YOLOLab/tree/main/scripts/Tracking) you can find the .yaml files for your tracker, as well as an additional script if you want to draw lines for your tracked paths.
